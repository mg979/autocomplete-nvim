...
let g:autocomplete.snippets = 'UltiSnips'
```
...
```vim
let g:autocomplete.auto_hover = 0
```
...
```vim
let g:autocomplete.auto_signature = 0
```
...
let g:autocomplete.sorting = "length"
```
...
```vim
let g:autocomplete.trigger_length = 3 " default = 1
```
...
```vim
let g:autocomplete.timer_cycle = 200 "default value is 80
```
