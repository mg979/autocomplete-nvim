...
local ctrlx = {
  ['line'] = "<c-g><c-g><c-x><c-l>",
  ['cmd']  = "<c-g><c-g><c-x><c-v>",
  ['defs'] = "<c-g><c-g><c-x><c-d>",
  ['dict'] = "<c-g><c-g><c-x><c-k>",
  ['file'] = "<c-g><c-g><c-x><c-f>",
  ['incl'] = "<c-g><c-g><c-x><c-i>",
  ['keyn'] = "<c-g><c-g><c-x><c-n>",
  ['keyp'] = "<c-g><c-g><c-x><c-p>",
  ['omni'] = "<c-g><c-g><c-x><c-o>",
  ['spel'] = "<c-g><c-g><c-x>s",
  ['tags'] = "<c-g><c-g><c-x><c-]>",
  ['thes'] = "<c-g><c-g><c-x><c-t>",
  ['user'] = "<c-g><c-g><c-x><c-u>",
  ['c-p'] = "<c-g><c-g><c-p>",
  ['c-n'] = "<c-g><c-g><c-n>",
}
